<x-app-layout>
    <x-slot name="slot">
        ...
        <div class="text-center mt-4">
            <button class="text-white bg-blue-700 hover:bg-blue-800 shadow-md focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" type="button" data-drawer-target="drawer-form" data-drawer-show="drawer-form" aria-controls="drawer-form">
            + Add Item
            </button>
        </div>
        ...
        <div id="drawer-form" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-form-label">
            ...
            <span class="sr-only">Close menu</span>
                ...
                <form method="POST" action="{{route('admin.item')}}" class="mb-6">
                    @csrf
                    <div class="mb-6">
