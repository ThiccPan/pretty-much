<x-app-layout>
    <x-slot name="slot">
        ...
        <div class="max-w-7xl mx-auto mt-4">
            <button class="text-black bg-gray-50 hover:bg-black hover:text-white shadow-lg focus:ring-4 focus:ring-white font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-black dark:hover:bg-black outline-1 outline-black dark:focus:ring-black" type="button" data-drawer-target="drawer-form" data-drawer-show="drawer-form" aria-controls="drawer-form">
            + Add Item
            </button>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                        ...
                        <td>
                            <a href="#" data-modal-toggle="defaultModal" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            ...
                            <div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                                <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                                    ...
                                    <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                                        ...
                                        <!-- Modal body -->
                                        <form method="POST" action="{{route('admin.item.update', $item)}}" class="mb-6" enctype="multipart/form-data" id="update-item">
                                            @csrf
                                            @method('put')
                                            <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                                ...
                                                <div>
                                                    ...
                                                    <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" name="category">
                                                        <option value="" class="text-gray-100:">old: {{$item->category}}</option>
                                            ...
                                            <button type="submit" class="text-white inline-flex items-center bg-black hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                        ...
                        <td>
                            <a href="{{route('admin.item.delete', ['item' => $item])}}" class="font-medium text-red-600 dark:text-blue-500 hover:underline" onclick="event.preventDefault();
                                document.getElementById('delete-form-{{ $item->id }}').submit();">
                                Delete
                            </a>

                            <form id="delete-form-{{ $item->id }}" action="{{ route('admin.item.delete', ['item' => $item]) }}"
        ...
        <div id="drawer-form" class="fixed top-0 left-0 z-40 h-screen p-4 overflow-y-auto transition-transform -translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-form-label">
            <h5 id="drawer-label" class="inline-flex items-center mb-6 text-base font-semibold text-gray-500 uppercase dark:text-gray-400"><svg class="w-5 h-5 mr-2" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path></svg>New Item</h5>
            ...
            <span class="sr-only">Close menu</span>
                ...
                <form method="POST" action="{{route('admin.item.create')}}" class="mb-6" enctype="multipart/form-data" id="add-item">
                    @csrf
                    <div class="mb-6">
                        <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                    ...
                    <div class="mb-6">
                        <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
                        <select id="category" class="bg-gray-50 border border-gray-300 text-gray-600 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" form="add-item" name="category">
                            <option value="cosmetic">cosmetic</option>
                            <option value="tools">tools</option>
                            <option value="hair">hair</option>
                            <option value="skincare">skincare</option>
                ...
                <button type="submit" class="text-black justify-center flex items-center bg-gray-50 hover:bg-black hover:text-white w-full focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 outline outline-offset-2 outline-1 outline-gray-300">
                    <svg class="w-5 h-5 mr-2" data-darkreader-inline-stroke="" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
